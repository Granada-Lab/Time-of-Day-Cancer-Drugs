    ...
    for c = 1:cc %loop c cell lines
        ...
        for d = 1:dd %loop d drug
            ...
            if c == 2 && d == 8
                ...
                excelfile = append('ToD_experiments_results/',date,'_ToD_Results_4d_',cellline{c},'.xlsx');
                [data] = readmatrix(excelfile,'Sheet',sheet1);
                [stdev] = readmatrix(excelfile,'Sheet',sheet2);
                ...
                for v = 1:2 %loop mcf10a and cancer cell line
                    ...
                    h1 = plot(xRange, yfitinterpolate(:,v));
                    ...
                    % fine-tune plots
                    set(h1,'LineWidth',2.5,'color',color,'HandleVisibility','off');
                    hold all
                    errorbar(timepoints,responses,err,marker,'MarkerSize',17,'LineWidth',3,'MarkerFaceColor',color,'Color',color);
                    ...
                    if v == 2
                        ...
                        min_benefit{d,col2} = max(foldchange([83:end],:));
                        ...
                        idx_min_diff = knnsearch(foldchange(83:end,1),1);
                        min_diff{d,col2} = foldchange(idx_min_diff+82);
                        time_min_diff{d,col2} = xRange(idx_min_diff+82);
                ...
                xlabel('Time of Day (%)',mainTextOpt{:});
                ...
                %save figure
%                 filename = append(date,'_ToD_',cellline{c},'_',drug{d},'_',channel{a},'_splinesmooth_max_min_benefit');
