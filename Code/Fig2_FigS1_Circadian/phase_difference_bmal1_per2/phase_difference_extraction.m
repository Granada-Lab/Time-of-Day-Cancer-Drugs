function phase_difference_extraction(path,cellline)

%Carolin Ector, 23.08.2023
%utilizes code of the Circular Statistics Toolbox Version 1.21.0.0 (46.2 KB) by Philipp Berens
%calculate phase difference between signals from the Bmal1 and Per2 reporter per cell line
%replicates stem from the same experiment

%Time-of-Day-Cancer-Drugs Manuscript Fig. S1b

%input: stored in phase_difference_extraction_workspace.mat
% path: path to .csv files where ridge readout from the continous wavelet transform is stored
...
varnames2 = {'mean_ph_diff';'median_ph_diff';'coeffvar_ph_diff'};
