...
%Function extracts ridge lengths from ridge readout files of continuous
%wavelet transform analysis

%Time-of-Day-Cancer-Drugs Manuscript Fig. 2h (data extraction)

%input: stored in "workspace_cwt_ridgelength.mat"
...
reporter = {'Bmal1';'Per2'}; %luciferase reporter
...
for n = 1:2 %loop n save values from the different Luc-reporters
