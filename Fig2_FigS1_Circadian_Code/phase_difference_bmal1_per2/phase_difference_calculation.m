function phase_difference_calculation(path,cellline)

%Carolin Ector, 23.08.2023

%Function utilizes code of the Circular Statistics Toolbox Version 1.21.0.0 (46.2 KB) by Philipp Berens
...
%input: stored in "workspace_phdiff_circular_statistics.mat"
...
for c = 1:cc %loop c cellline
    ...
    %save figure
    filetext = append('phdiff_over_time_',cellline{c},'.svg');
